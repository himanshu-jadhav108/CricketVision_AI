...
def main():
    ...
    print("=" * 65)
    print("Stale Asset Comparison:")
    print("  • eval_confusion_matrix_pct.png: Old: 7 classes (incl straight_drive) -> New: 6 classes")
    print("  • eval_per_class_f1.png         : Old: 7 classes -> New: 6 classes")
    print("  • feature_importance.png        : Old: stale velocity/bat features (vel_*) -> New: 51 real features")
    print("  • eda_class_distribution.png   : Old: '7 Shot Classes' -> New: '6 Shot Classes'")
    print("-" * 65)
    print("Untouched Assets Flagged (not verified in this step):")
    print("  • confusion_matrix.png (non-pct raw matrix)")
